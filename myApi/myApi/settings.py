...
SECRET_KEY = 'django-insecure-le7wsum_f$eh=7d4hcz4jm+5(-a@7cd(a%+20&g3ie(!m$m=(f'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "candysoftpruebaapi@gmail.com"  # Tu correo
EMAIL_HOST_PASSWORD = "ikyp huvb lnia zekw"  # La contraseña o App Password
